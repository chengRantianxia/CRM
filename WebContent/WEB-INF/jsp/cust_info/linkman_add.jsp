...
<form action="${cstId}/linkman_add/baocun" method="post" onsubmit="return linkman_addcheck()">
...
<table class="query_form_table">
	<tr>
		<th>姓名</th>
			<td><input type="text" name="lkmName" id="lkmName"/><span class="red_star" id="lkm_nameinpspan">*</span></td>
		<th>性别</th>
		<td>
