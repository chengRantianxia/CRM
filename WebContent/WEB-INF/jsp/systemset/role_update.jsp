...
<body>
   <table width="100%" cellSpacing=0 cellPadding=0 border="0px">
	...
	<form action="systemset/role_update/save" method="post">
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				...
				<td><input readonly="readonly" name="roleId" type="text"
					value="${roleBySysRoleId.roleId}" /></td>
			</tr>
			<tr>
				<th>角色名</th>
				<td><input type="text" name="roleName"
					value="${roleBySysRoleId.roleName}" /><span class="red_star">*</span></td>
			</tr>
			<tr>
				<th>描述</th>
				<td><input type="text" cols="50" rows="4" name="roleDesc"
					value="${roleBySysRoleId.roleDesc}" /><span
					class="red_star">*</span></td>
			</tr>
			<tr>
				<th>状态</th>
				<td colspan="3"><input name="role_flag" type="radio" value="1"
					checked="checked" />有效 <input name="roleFlag" type="radio"
					value="0" />无效</td>
			</tr>
			<tr>
