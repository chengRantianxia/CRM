...
<table class="query_form_table" cellSpacing=1 cellPadding=1>
	...
	<tr>
		<th>创建人</th>
		<td colspan="3">${chance.chcCreateBy }</td>
	</tr>
</table>
<br />

<form action="sale/dispatch/save"  method="post">
	...
	<tr>
		...
		<td>
			<select name="chcDueTo"> 
				<c:if test="${chance.chcDueTo }=null">
				<option>请选择...</option></c:if>
				<option>${chance.chcDueTo }</option>
