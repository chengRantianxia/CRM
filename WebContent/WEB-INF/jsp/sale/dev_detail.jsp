...
<table class="query_form_table" cellSpacing=1 cellPadding=1 >
	...
	<tr>
		...
		<tr>
			<th>事件</th>
			<td><input type="text" name="plaTodo" id="plaTodo" value="${plan.plaTodo }"/></td>
			<th>结果</th>
			<td><input type="text" name="plaResult" id="plaResult" value="${plan.plaResult }"/></td>
		</tr>
		<tr>
	<tr>
    	<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
        	<a href="help"><input class="common_button"  type="button" value="帮助"></a>&nbsp;&nbsp;&nbsp;
			    <a href="1/sale/dev"><input class="common_button"  type="button" value="返回"></a>
        </td>
    </tr>
</table>
<br />
